<?php $__env->startSection('title', 'Laporan Gaji per Lokasi'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>Laporan Gaji per Lokasi</h1>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('laporan.per-lokasi.export', request()->all())); ?>" class="btn btn-success">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('laporan.per-lokasi')); ?>" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('laporan.per-lokasi')); ?>" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/10969sosho/PROJECT/CVSS/SUDAH_TAYANG/BU VANIA/1. PROGRAM GAJI /resources/views/laporan/per-lokasi.blade.php ENDPATH**/ ?>