<?php $__env->startSection('title', 'Edit Bibit'); ?>
...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('bibit.update', $bibit)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="<?php echo e($lokasi->id); ?>" <?php echo e(old('lokasi_id', $bibit->lokasi_id) == $lokasi->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="<?php echo e($kandang->id); ?>" data-lokasi="<?php echo e($kandang->lokasi_id); ?>" <?php echo e(old('kandang_id', $bibit->kandang_id) == $kandang->id ? 'selected' : ''); ?>>
                                <?php echo e($kandang->nama_kandang); ?><?php if($kandang->bibit && $kandang->bibit->id != $bibit->id): ?> (Sudah Ada Bibit)<?php endif; ?>
                            </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('jenis_bibit', $bibit->jenis_bibit)); ?>" placeholder="Contoh: Ayam Broiler" required>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('tanggal_masuk', $bibit->tanggal_masuk->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('tanggal_selesai', $bibit->tanggal_selesai ? $bibit->tanggal_selesai->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="aktif" <?php echo e(old('status', $bibit->status) == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                            <option value="non-aktif" <?php echo e(old('status', $bibit->status) == 'non-aktif' ? 'selected' : ''); ?>>Non Aktif</option>
                            <option value="sudah selesai" <?php echo e(old('status', $bibit->status) == 'sudah selesai' ? 'selected' : ''); ?>>Sudah Selesai</option>
                        </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/10969sosho/PROJECT/CVSS/SUDAH_TAYANG/BU VANIA/1. PROGRAM GAJI /resources/views/bibit/edit.blade.php ENDPATH**/ ?>