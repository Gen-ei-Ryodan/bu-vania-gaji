<?php $__env->startSection('title', 'Edit Kandang'); ?>
...
<div class="row">
    <div class="col-md-6 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('kandang.update', $kandang)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="<?php echo e($lokasi->id); ?>" <?php echo e(old('lokasi_id', $kandang->lokasi_id) == $lokasi->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('nama_kandang', $kandang->nama_kandang)); ?>" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/10969sosho/PROJECT/CVSS/SUDAH_TAYANG/BU VANIA/1. PROGRAM GAJI /resources/views/kandang/edit.blade.php ENDPATH**/ ?>