...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('laporan.admin.export', request()->all())); ?>" class="btn btn-success">
            <i class="bi bi-download"></i> Export XLSX
        </a>
        <a href="<?php echo e(route('laporan.admin.export-pdf', request()->all())); ?>" class="btn btn-danger">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('laporan.admin')); ?>" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input type="date" name="start_date" class="form-control" value="<?php echo e(request('start_date', now()->startOfMonth()->format('Y-m-d'))); ?>">
            </div>
            <div class="col-md-3">
                <label class="form-label">Tanggal Akhir</label>
                <input type="date" name="end_date" class="form-control" value="<?php echo e(request('end_date', now()->endOfMonth()->format('Y-m-d'))); ?>">
            </div>
            <div class="col-md-3">
                <label class="form-label">&nbsp;</label>
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary flex-fill">Filter</button>
                    <a href="<?php echo e(route('laporan.admin')); ?>" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
    </div>
...
<div class="card">
    <div class="card-body">
        ...
        <h5 class="card-title">Periode: <?php echo e(\Carbon\Carbon::parse($report['start_date'])->format('d/m/y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($report['end_date'])->format('d/m/y')); ?></h5>
            ...
            <table class="table table-striped">
                ...
                <tfoot>
                    <tr class="fw-bold table-secondary">
                        ...
                        <td><?php echo e($grandTotalFull); ?></td>
                        <td><?php echo e($grandTotalHalf); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/10969sosho/PROJECT/CVSS/SUDAH_TAYANG/BU VANIA/1. PROGRAM GAJI /resources/views/laporan/admin.blade.php ENDPATH**/ ?>